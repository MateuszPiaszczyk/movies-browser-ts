...
export const TitleDetails = styled.h2<{ theme: Theme }>`
  margin: 8px 0 24px;
  font-size: 36px;
  font-weight: 600;
  line-height: 1.2;
...
export const SubtitleDetails = styled.span<{ theme: Theme }>`
  font-size: 22px;
  font-weight: 400;
  line-height: 1.2;
...
export const Attribute = styled.span<AttributeProps & { theme: Theme }>`
