...
export const Tile = styled.div`
  ...
  box-shadow: 0px 4px 12px ${({ theme }: { theme: Theme }) => theme.colors.lightHeather};
  width: 100%;
  height: 100%;
  display: grid;
  ...
  &:hover {
    transform: scale(105%);
    box-shadow: 0px 4px 12px ${({ theme }: { theme: Theme }) => theme.colors.waterloo};
  }
...
export const PhotoWrapper = styled.div`
  ...
  background-size: 100%;
  background-color: ${({ theme }: { theme: Theme }) => theme.colors.silver};
